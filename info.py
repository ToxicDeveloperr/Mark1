...
auth_channel = environ.get('AUTH_CHANNEL', '-1002109611442 -1002126079576')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tejaschavan1110:v6C6ZNSty2AmoMOs@cluster0.20nyiir.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://lazyangel-tej.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lazyangel-tej.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lazyangel-tej.koyeb.app/".format(FQDN)
else:
    URL = "https://lazyangel-tej.koyeb.app/".format(FQDN)
